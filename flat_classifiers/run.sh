...
asset="transformer_1e-6LearningRate_200Epochs_0.5Dropout_2Heads_RemovedDenseLayerInOutput_EmbeddingMaskTrue_DropoutOnTestFalse"
model="transformer"
timestamp="$(date +"%T")"
mkdir -p "assets/logs"
cd "assets/logs"
...
# #When experimenting
# asset="lstm_6e-6LearningRate_200Epochs_0.5Dropout"
# model="lstm"
# timestamp="$(date +"%T")"
# mkdir -p "assets/logs"
# cd "assets/logs"
